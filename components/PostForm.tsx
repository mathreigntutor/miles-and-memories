...
import { Post, CATEGORIES } from '@/lib/db';
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-stone-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-amber-400 text-stone-800 placeholder:text-stone-300"
        />
        <p className="text-xs text-stone-400 mt-1">Tip: Use free images from <a href="https://unsplash.com" target="_blank" className="text-amber-600 underline">unsplash.com</a> — right-click any image and copy its URL.</p>
      </div>
